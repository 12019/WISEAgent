...
config_RMM ()
{
	...
	if [ $ssltype == 0 ]; then
        ...
        echo "****************************************************************************************************"
	read -p "Do you want to configure RMM Agent now? [y/n](default: y)" RMM_config_ans
	if [ "$RMM_config_ans" == "y" ] ||[ "$RMM_config_ans" == "Y"  ] ||[ "$RMM_config_ans" == ""  ]; then
...
#		fi
				update_config					
################################################################################################################
	elif [ "$RMM_config_ans" == "n" ] ||[ "$RMM_config_ans" == "N"  ]; then
		#update_config
...
#	if [ $reconn == "disable" ]; then
		echo "****************************************************************************************************"
		read -p "Do you want to start RMM Agent now? [y/n](default: y)" RMM_start_ans
